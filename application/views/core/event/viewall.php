...
<body>
	...
	<?php
		...
		foreach($objects as $obj){
			...
			echo "<tr><td>{$i}</td><td>{$obj->event_name}</td><td>{$obj->event_description}</td><td>{$obj->event_datetime}</td><td><a href=\"{$viewmember}\">View Members</a> | <a href=\"{$addmember}\">Add Members</a> | <a href=\"{$editurl}\">Edit</a> | <a href=\"{$deleteurl}\" class=\"deletelink\">Delete</a></td></tr>";
			$i = $i+1;
		}
	?>
	</table>
